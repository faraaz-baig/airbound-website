<div class="section_3 bg-blue-600">
	<div class="max-w-1260 mx-auto py-28">
		<h1 class="font-heading text-2xl md:text-4xl text-white-100 text-center mx-auto font-semibold">
			Empower your business <span class="text-green-500">one delivery at a time</span>
		</h1>
		<div class="mt-16 grid grid-cols-4 gap-10 md:grid-cols-8 lg:grid-cols-12 px-10">
			<div class="col-span-2 md:my-0 lg:col-span-3 my-10">
				<img
					class="mx-auto w-32 md:w-36 lg:w-40"
