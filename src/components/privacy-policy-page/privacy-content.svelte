<main class="col-span-4 md:col-span-8 lg:col-span-12">
	...
	<p>
		At Airbound, accessible from https://airbound.co, one of our main priorities is the privacy of
		our visitors. This Privacy Policy document contains types of information that is collected and
		recorded by Airbound and how we use it.
	</p>
	...
	<p>
		Airbound follows a standard procedure of using log files. These files log visitors when they
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on Airbound, which are
	...
	<p>
		Note that Airbound has no access to or control over these cookies that are used by third-party
		advertisers.
	</p>
	...
	<p>
		Airbound's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
	...
	<p>
		Airbound does not knowingly collect any Personal Identifiable Information from children under
